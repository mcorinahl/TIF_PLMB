...
%  Compilar con: pdflatex README.tex (dos pasadas)
% ============================================================
...
Prueba de sensibilidad a la definición del grupo de control. En lugar de usar toda la ciudad como control (especificación base), define un contrafactual espacialmente acotado: las manzanas dentro de un \textbf{buffer de 1200m alrededor de la nueva área de influencia} pero por fuera del área de tratamiento.
...
\vspace{2cm}
\begin{center}
  \textcolor{gray}{\small Documentación generada con Claude Code (claude-sonnet-4-6) · Marzo 2026}
\end{center}
